...
### 📚 核心课程与书籍
- **课程**: [《动手学深度学习》](https://zh.d2l.ai/) - 深度学习基础的最佳入门
- **课程**: [清华大模型公开课第二季](https://www.bilibili.com/video/BV1pf421z757) - 系统了解大模型历史与前沿
...
- **Agent**: [ReAct](https://arxiv.org/abs/2210.03629), [Reflexion](https://arxiv.org/abs/2303.11366), [Tree of Thoughts](https://arxiv.org/abs/2305.10601)
- **RAG**: [DPR](https://arxiv.org/abs/2004.04906), [Self-RAG](https://arxiv.org/abs/2310.11511), [GraphRAG](https://www.microsoft.com/en-us/research/project/graphrag/)
- **RL**: [DPO](https://arxiv.org/abs/2305.18290), [GRPO](https://arxiv.org/pdf/2402.03300), [DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1)
...
### 🌐 学习社区与资源
- **论文库**: [Huggingface Daily Papers](https://huggingface.co/papers), [Cool Papers](https://papers.cool/), [ML Papers Explained](https://github.com/dair-ai/ML-Papers-Explained)
...
| **天数** | **学习主题**              | **资源链接**                                                                                                                                                                                     | **目标**                                          |
| ------ | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| 15     | Reflexion 论文精读        | 论文: [Reflexion](https://arxiv.org/abs/2303.11366)<br>解读: [Reflexion 论文解读](https://www.interconnects.ai/p/reflexion)<br>扩展: [Self-Refine](https://arxiv.org/abs/2303.17651)                   | 掌握其"Actor -> Evaluator -> Self-Reflection"的算法流程 |
| 16     | Reflexion 算法分析        | 伪代码: [Reflexion 官方伪代码](https://github.com/noahshinn/reflexion/blob/main/ALGORITHM.md)<br>相关: [Chain of Thought](https://arxiv.org/abs/2201.11903)                                            | 分析反思机制如何帮助 Agent 从失败中学习，并尝试用伪代码实现               |
| 17     | Tree of Thoughts 论文精读 | 论文: [Tree of Thoughts](https://arxiv.org/abs/2305.10601)<br>代码: [ToT 开源代码实现](https://github.com/kyegomez/tree-of-thoughts)<br>相关: [Self-Consistency](https://arxiv.org/abs/2203.11171)       | 理解如何将 LLM 作为搜索算法的启发式函数                          |
| 18     | ToT 算法实战              | 任务: [24点游戏](https://en.wikipedia.org/wiki/24_Game)<br>博客: [Prompt Engineering Guide](https://www.promptingguide.ai/)                                                                         | 实现一个简化的 ToT 搜索策略来解决 24点游戏                       |
| 19     | Multi-Agent 协作模式      | 论文: [MetaGPT](https://arxiv.org/abs/2308.00352)<br>论文: [Communicative Agents](https://arxiv.org/abs/2307.07924)<br>论文: [AutoGen](https://arxiv.org/abs/2308.08155)                           | 学习 MetaGPT 中角色定义 (SOPs) 和协作模式                   |
| 20     | AutoGen 框架实战          | 文档: [AutoGen 官方教程](https://microsoft.github.io/autogen/docs/getting-started/)<br>替代: [AgentScope](https://github.com/modelscope/agentscope), [CrewAI](https://github.com/joaomdmoura/crewAI) | 使用 AutoGen 搭建一个简单的 Coder 和 Critic Agent         |
| 21     | 周度总结与对比分析             | 综述: [Awesome Agent Reasoning](https://github.com/atfortes/Awesome-LLM-Reasoning)                                                                                                             | 绘制 ReAct, Reflexion, ToT 的算法流程对比图，总结优劣          |
|        |                       |                                                                                                                                                                                              |                                                 |
...
| 28     | Agentic RAG 算法设计 | 教程: [Learn RAG From Scratch](https://www.youtube.com/watch?v=sVcwVQRHIc8)<br>课程: [OpenRAG](https://openrag.notion.site/Open-RAG-c41b2a4dcdea4527a7c1cd998e763595)                                                                                         | 思考如何设计一个能进行多步推理的 Agentic RAG 策略，并绘制流程图                     |
...
| **天数** | **学习主题**               | **资源链接**                                                                                                                                                                                                                                                                                                                              | **目标**                                             |
| ------ | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| 29     | Agent Memory 概述        | 博客: [LLM Powered Agents - Memory](https://lilianweng.github.io/posts/2023-06-23-agent/#memory)<br>工具: [Mem0](https://github.com/mem0ai/mem0), [MemoryScope](https://github.com/modelscope/MemoryScope)<br>论文: [Agent Memory 综述](https://github.com/WangRongsheng/awesome-LLM-resources/tree/main/resources/agent/papers/agent_memory) | 梳理 Agent 记忆的分类和挑战                                  |
| 30     | Generative Agents 论文精读 | 论文: [Generative Agents](https://arxiv.org/abs/2304.03442)<br>博客: [Generative Agents 解读](https://blog.ml.cmu.edu/2023/09/08/generative-agents/)                                                                                                                                                                                        | 学习其对记忆进行评分 (Recency, Importance, Relevance) 和检索的机制 |
| 31     | MemGPT 论文精读            | 论文: [MemGPT](https://arxiv.org/abs/2310.08560)<br>代码: [MemGPT 开源库](https://github.com/cpacker/MemGPT)<br>相关: [Anthropic Context](https://www.anthropic.com/news/claude-2-1)                                                                                                                                                           | 学习其分层记忆和函数调用管理虚拟上下文的方法                             |
| 32     | MemGPT 实战              | 教程: [MemGPT Tutorial](https://memgpt.readme.io/docs/quickstart)<br>扩展: [LangMem](https://github.com/cpacker/MemGPT)                                                                                                                                                                                                                   | 运行 MemGPT 官方示例，理解其工作流程                             |
| 33     | 上下文压缩技术                | 教程: [LlamaIndex Context Stuffing](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/root.html)<br>论文: [LongLLMLingua](https://arxiv.org/abs/2310.06839)                                                                                                                                               | 学习并实现不同的上下文填充和压缩策略                                 |
| 34     | 上下文选择与过滤               | 教程: [LlamaIndex Node Postprocessors](https://docs.llamaindex.ai/en/stable/module_guides/querying/node_postprocessors/node_postprocessors.html)<br>论文: [Lost in the Middle](https://arxiv.org/abs/2307.03172)                                                                                                                          | 实现一个自定义的后处理器来优化上下文选择                               |
...
| 41     | RL for Tool Learning  | 论文: [Toolformer](https://arxiv.org/abs/2302.04761)<br>论文: [ReAct RL](https://arxiv.org/abs/2210.03629)<br>资源: [Agent+RL项目汇总](https://github.com/WangRongsheng/awesome-LLM-resources/tree/main/resources/agent/papers/agent_rl)                     | 学习如何用 RL 思想让模型学会使用工具                 |
| 42     | 奖励模型设计                | 教程: [TRL Reward Modeling](https://huggingface.co/docs/trl/main/en/reward_trainer)<br>框架: [RM-Gallery](https://github.com/modelscope/RM-Gallery)<br>书籍: [RLHF Book](https://github.com/natolambert/rlhf-book)                                       | 学习如何为 Agent 任务设计奖励函数/训练奖励模型          |
...
| **天数** | **学习主题**                  | **资源链接**                                                                                                         | **目标**                             |
| ------ | ------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| 61     | 论文撰写 (Intro & Conclusion) | 模板: [Overleaf ACL Template](https://www.overleaf.com/latex/templates/acl-2023-proceedings-template/qjdgcrdwvxpf)<br>指南: [论文写作技巧](https://www.cs.cmu.edu/~jbigham/pubs/pdfs/2018/chi2018-writing-tips.pdf) | 完成引言、结论和摘要部分的初稿，并进行全文校对            |
| 62     | 代码开源与博客撰写                 | 指南: [如何写好 README](https://www.makeareadme.com/)<br>平台: [Huggingface](https://huggingface.co/), [GitHub](https://github.com/)                                                                  | 整理代码，撰写 README，并写一篇技术博客解读你的项目      |
| 63     | 简历项目经历打磨                  | 指南: [Tech Resume Guide](https://www.techinterviewhandbook.org/resume/)<br>参考: [AI面试指南](https://github.com/WangRongsheng/awesome-LLM-resources/tree/main/docs/04-interview)                                                                                                                  | 按照 STAR-算法版 模板，将你的项目经历写入简历         |
| 64     | 准备项目介绍逐字稿                 | 模板: [STAR方法](https://www.indeed.com/career-advice/interviewing/how-to-use-the-star-interview-response-technique)                                                                                                                  | 准备一个 3-5 分钟的项目介绍，覆盖 S/T/A/R 各个环节   |
| 65     | 模拟项目深挖                    | 题库: [LLM系统设计面试题](https://www.analyticsvidhya.com/blog/2024/04/rag-interview-questions/)                                                                                                                  | 针对 "为什么不用XX方法"、"算法的局限性" 等问题准备回答    |
| 66     | 算法理论题复习                   | 题库: [AI Interview Questions](https://github.com/Complete-AI-Recruiting/AI-Interview-Questions)<br>笔记: [LLMs Interview Note](https://github.com/wdndev/llm_interview_note)<br>课程: [ML Papers Explained](https://github.com/dair-ai/ML-Papers-Explained)                   | 复习 Transformer, RL, RAG 等核心理论高频面试题 |
| 67     | 模拟面试与总结                   | 资源: [LLM Evaluation: A Complete Course](https://www.comet.com/site/llm-course/)<br>社区: [AI研究社群](https://github.com/WangRongsheng/awesome-LLM-resources#%E7%A4%BE%E5%8C%BA-community)                                                                                                                  | 进行 1v1 模拟面试，复盘并改进                  |
